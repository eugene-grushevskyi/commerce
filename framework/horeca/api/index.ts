...
const STORE_API_TOKEN = process.env.STORE_API_TOKEN
const STORE_API_CLIENT_ID = process.env.STORE_API_CLIENT_ID
const STORE_CHANNEL_ID = process.env.CHANNEL_ID
