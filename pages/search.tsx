...
export default function Search({
  ...
  const getDeclination = (num: number) => {
    const cases = [2, 0, 1, 1, 1, 2]
    const txt = ['результат', 'результати', 'результатів']
    return txt[
  ...
  return (
    <Container>
      <div className="grid grid-cols-1 lg:grid-cols-12 mt-3 mb-20">
            ...
            <div className="mb-6 transition ease-in duration-75">
              {data ? (
                <>
                  ...
                  >
                    {products.length} {getDeclination(products.length)}{' '}
                    {q && (
                      <>
                        for "<strong>{q}</strong>"
                      </>
